...
public class FillInfoDatabase extends AsyncTask<Context, Void, Void> {
    Context context;
    Long traitIds[];

    //region setup Trait Background array
    ...
    String[][][] allTraits = new String[][][]
            {
                    new String[][]{
                            ...
                            "I am suspicious of strangers and expect the worst of me.",
                            "Once I pick a goal, I become obsessed with it to the detriment of everything else in my life.",
                        },
                    },
                    new String[][]
                            {
                                    new String[]{"Charlatan"},
                                    ...
                                    new String[]{
                                            ...
                                            "Somewhere out there, I have a child who doesn't know me. I am making the world better for him or her.",
                                            "I come from a noble family, and one day I will reclaim my lands and title from those who stole me from me.",
                                            "A powerful person killed someone I love. Some day soon, I will have my revenge.",
                                            "I swindled and ruined a person who didn't deserve it. I seek to atone for my misdeeds but might never be able to forgive myself.",
                                    },
                                    new String[]{
                                            "I can't resist a pretty face.",
                                            "I am always in debt. I spend my ill-gotten gains on decadent luxuries faster than I bring me in...",
                                            "I am convinced that no one could ever fool me the way I fool others.",
                                            "I am too greedy for my own good. I can't resist taking a risk if there's money involved.",
                    ...
                    new String[][]
                            {
                                    ...
                                    "I am always calm, no matter what situation. I never raise my voice or let my emotions control me.",
                                    ...
                                    "If there's a plan, I will forget it. If I don't forget it, I will ignore it.",
                    ...
                    new String[][]
                            {
                                    ...
                                    "Sincerity. There's no good in pretending to be something I am not.",
                                    "Destiny. Nothing and no one can steer me away from my higher calling.",
                            },
                                    new String[]{
                                    "I have a family, but they have no idea where I am. One day, I hope to see them again.",
                                    "I worked the land, I love the land, and I will protect the land.",
                                    "A proud noble once gave me a horrible beating, and I will take my revenge on any bully I encounter.",
                                    "My tools are symbols of my past life, and I carry me so that I will never forget my roots.",
                                    "I protect those who cannot protect myself.",
                    ...
                    new String[][]
                            {
                                    new String[] {"Guild Artisan"},
                                    new String[]{
                                    "I believe that anything worth doing is worth doing right. I can't help it, I am a perfectionist.",
                                    ...
                                    "I am well known for my work, and I want to make sure everyone appreciates it. I am always taken aback when people haven't heard of me.",
                                    ...
                                    "One day I will return to my guild and prove that I am the greatest artisan of me all.",
                    ...
                    new String[][]
                            {
                                    ...
                                    "I like keeping secrets and won't share me with anyone.",
                            }
                    ...
                    new String[][]
                            {
                                    new String[] {"Outlander"},
                                    new String[]{
                                    "I am driven by a wanderlust that led me away from home.",
                                    "I watch over my friends as if I were a litter of newborn pups.",
                                    ...
                                    "I am always picking things up, absently fiddling with it, and sometimes accidentally breaking it.",
                                    ...
                                    "Honour. If I dishonor myself, I dishonour my whole clan.",
                                    ...
                                    new String[]{
                                    "My family, clan, or tribe is the most important thing in my life, even when I am far from me.",
                                    ...
                                    "Don't expect me to save those who can't save themself. It is nature's way that the strong thrive and the weak perish.",
                            }
                    ...
                    new String[][]
                            {
                                    ...
                                    "Most people scream and run when I see a demon. I stop and take notes on its anatomy.",
                    ...
                    new String[][]
                            {
                                    ...
                                    "I've lost too many friends, and I am slow to make new ones.",
                                    ...
                                    "I fight for those who cannot fight for themself.",
                            },
                                    new String[]{
                    ...
                    new String[][]
                            {
                                    ...
                                    "People. I help the people who help me- that's what keeps everyone alive.",
                                    ...
                                    "I would rather kill someone in their sleep then fight fair.",
                                    "It's not stealing if I need it more than someone else.",
                                    "People who can't take care of themself get what they deserve.",
                            }

                            }

            };
    //endregion setup Trait Background array

    @Override
    protected Void doInBackground(Context... params) {
        context = params[0];
        String[] StringTraitArray = context.getResources().getStringArray(R.array.dnd_traits);
        traitIds = new Long[StringTraitArray.length];
        InfoDatabase db = Room.databaseBuilder(context, InfoDatabase.class, context.getString(R.string.IDB)).build();

        //Clearing tables
        db.traitDao().deleteAll();
        db.backgroundDao().deleteAll();
        db.traitTypeDao().deleteAll();

        //Inserting trait types into the db
        for (int i = 0; i < StringTraitArray.length; i ++)
            traitIds[i] = db.traitTypeDao().insertTraitType(new TraitType(StringTraitArray[i]));
        for (int backgroundLoop = 0; backgroundLoop < allTraits.length; backgroundLoop ++ )
        {
            Background background =  new Background(allTraits[backgroundLoop][0][0]);
            long backgroundId = db.backgroundDao().insertBackground(background);
            for (int traitLoop = 1; traitLoop < allTraits[backgroundLoop].length; traitLoop ++)
            {
                long traitId = traitIds[traitLoop -1];
                for(int traitDetail = 0; traitDetail < allTraits[backgroundLoop][traitLoop].length; traitDetail ++)
                {
                    Trait newTrait = new Trait(backgroundId, traitId, allTraits[backgroundLoop][traitLoop][traitDetail]);
                    db.traitDao().insertTrait(newTrait);
                }
